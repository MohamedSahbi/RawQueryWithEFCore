...
namespace SampleWithEFCore.Repository
{
    public class StudentRepository
    {
        ...
        public async Task<double> GetScore(int studentId)
        {
            ...
            var gradeList = await _universityContext.Query<AverageGrade>().FromSql(query,idParam).ToListAsync();
